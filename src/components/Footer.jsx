...
const Footer = () => {
    return (
        <section className="footer" data-aos="fade-up">
            ...
            <div className="footer-text px-4">iCS Hack The World - Organized by the ISACA Student Group of UCSC</div>
            <div className="socials">
                ...
                <div className="socials-instagram"><a href="https://instagram.com/ucsc_isg?utm_medium=copy_link"
                                                      target="_blank"
                                                      rel="noreferrer">
            ...
            <div className="footer-copyright px-2">Copyright © 2021 ICS. All rights reserved.</div>
        </section>
    );
};
